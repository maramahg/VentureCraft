  ...
  return (
    <section className="section-padding relative" style={{ background: '#0B2A24' }}>
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        ...
        {/* Tab list */}
        <div className="flex items-center justify-center gap-3 flex-wrap mb-10 sm:mb-16" role="tablist">
          {getInvolvedTabs.map((tab) => (
            <button
              ...
              className={`px-5 sm:px-6 py-2.5 sm:py-3 rounded-full text-xs font-bold uppercase tracking-wider transition-all duration-300 font-poppins border ${
                activeTab === tab.id
            ...
            >
              ...
              <div className="flex flex-col justify-center">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#4FD1C5] text-[#001A18] text-sm font-bold hover:bg-[#5ae0d4] transition-all duration-300 hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(79,209,197,0.2)] group w-max"
                >
                  {activeData.cta}
