...
const faqData: FAQItem[] = [
    ...
    },
    {
        ...
        answer: 'If you are a motivated university student with an interest in startups, technology, and sustainability, we invite you to join the Venture Craft Ambassadors Program and be part of a global movement driving innovation forward. Outstanding engagement and impact may lead to exclusive event invitations.',
