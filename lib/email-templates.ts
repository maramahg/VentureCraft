...
export const getEmailHtml = (options: EmailTemplateOptions) => {
  ...
  const borderThickness = isAnnouncement ? '0px' : '1px';
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#001311" style="background-color: #001311;">
    <tr>
      <td align="center" valign="top" style="padding: 60px 10px;">
        ...
        <table class="main-table" border="0" cellpadding="0" cellspacing="0" width="600" bgcolor="${mainBg}" style="width: 600px; background-color: ${mainBg}; border: ${isAnnouncement ? '0' : '1px solid #1a3a36'}; border-radius: 24px; border-collapse: collapse; overflow: hidden;">
          
          ${isAnnouncement ? `
          <!-- Announcement Bell Header (No Border) -->
          <tr>
            <td align="center" style="padding: 50px 20px 20px;">
               <table border="0" cellpadding="0" cellspacing="0" width="100" height="100" style="width: 100px; height: 100px; background-color: #ffffff; border-radius: 50%;">
                    <tr>
          ...
          <tr>
            <td align="center" bgcolor="#081514" style="padding: 30px 40px; background-color: #081514; border-top: 1px solid #1a3a36;">
              ...
              <p style="color: #2c4a45; font-family: Arial, sans-serif; font-size: 11px; margin: 0; font-weight: bold;">
                Build Your Venture <span style="display:none !important; font-size:1px; color:#081514; line-height:1px;">${uniqueId}</span>
              </p>
            </td>
          </tr>
